...
<body>
    <div class="container-fluid position-static top-50 start-50">
        <div class="row justify-content-center p-5">
            <h1 class="text-center shadow-lg p-3 mb-5 bg-body-tertiary bg-success-subtle rounded-5">Agregar Nuevo Hotel</h1>
                ...
                <form action="<?= base_url('agregar_hotel') ?> " method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="txtCiudadId" name="txtCiudadId" aria-label="Default select example">
                            <option selected>seleccione una id de ciudad</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="txtCategoriaId" name="txtCategoriaId" aria-label="Default select example">
                            <option selected>seleccione una categoria id</option>
